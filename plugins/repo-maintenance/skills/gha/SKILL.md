---
name: "gha"
description: "Upgrade GitHub Actions workflow dependencies with actions-up, respecting the project's release-age cool-down. Use when the user asks to upgrade or update GitHub Actions workflow dependencies, check for outdated actions, or use actions-up."

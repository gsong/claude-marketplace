---
name: pnpm-upgrade
description: Use when the user asks to upgrade, update, or bump the pnpm version itself (not dependencies), or wants to update pnpm version references across a project. Also use when the user invokes /pnpm-upgrade.
---

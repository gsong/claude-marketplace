...
description: Use when the user asks to upgrade, update, or bump pnpm project dependencies, or wants to check for outdated packages. Works for both single-project and monorepo/workspace setups. Also use when the user invokes /pnpm-upgrade-dependencies.
---
